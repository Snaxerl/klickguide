...
export function button(label, name, handler, variant = 'secondary') {
...
export function iconButton(label, name, handler, variant = 'ghost') {
...
export function link(label, href, name, className = '') {
...
export function textInput(value = '', maximum = 200, placeholder = '') {
...
export function textArea(value = '', maximum = 5000, rows = 3) {
...
export function confirmDialog(title, message, confirmLabel = 'Bestätigen', destructive = false) {
...
export function askTitle(title, initial = '') {
    const view = modal(title);
