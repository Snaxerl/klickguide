...
export function rectangleFromPoints(startX, startY, endX, endY) {
...
export function sameViewport(first, second) {
...
export function annotationsAfterCrop(annotations, crop) {
