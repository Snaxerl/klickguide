...
export async function exportImages(bundle) {
...
export async function downloadBackup(bundle) {
    const backup = { format: 'klickguide', version: 1, guide: bundle.guide, images: [] };
...
export async function importFile(file) {
    ...
    const bundle = { guide: backup.guide, images: [] };
